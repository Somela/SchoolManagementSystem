...
{
    public class BookLibrarySqlParameterCollection
    {
        public static SqlCommand GetBookLibrarySqlParameterCollection(IConfiguration configuration, string queryStoreProcedure)
        {
