...
{
    public class ClassSqlParameterCollection
    {
        public static SqlCommand GetClassSqlParameterCollection(IConfiguration configuration, string queryStoreProcedure)
        {
